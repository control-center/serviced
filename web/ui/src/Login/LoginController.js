...
(function() {
    ...
    controlplane.controller("LoginController", ["$scope", "$location", "$notification", "$translate", "authService", "servicedConfig",
    function($scope, $location, $notification, $translate, authService, servicedConfig) {
