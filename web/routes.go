...
func (sc *ServiceConfig) getRoutes() []rest.Route {
	...
	routes := []rest.Route{
		...
		rest.Route{"PUT", "/services/restartServices", gz(sc.authorizedClient(restRestartServices))},
		rest.Route{"PUT", "/services/startServices", gz(sc.authorizedClient(restStartServices))},
		rest.Route{"PUT", "/services/stopServices", gz(sc.authorizedClient(restStopServices))},
