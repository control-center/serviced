...
func (s *StrategySuite) TestSimplePreferSeparate(c *C) {
	...
	strat := strategy.PreferSeparateStrategy{}
...
func (s *StrategySuite) TestComplexPreferSeparate(c *C) {
...
func (s *StrategySuite) TestOversubscribedPreferSeparate(c *C) {
	hostA := newHost(2, 5)
	hostB := newHost(2, 6)
