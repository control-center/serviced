...
$(_DESTDIR)$(prefix)/bin_TARGETS                  += pkg/serviced-container-cleanup
$(_DESTDIR)$(prefix)/bin_TARGETS                  += pkg/serviced-container-usage
$(_DESTDIR)$(prefix)/bin_TARGETS                  += pkg/serviced-btrfs-maintenance
