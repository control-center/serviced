...
func (c *Client) ServiceUse(serviceID string, imageID string, replaceImg string, registry string, noOp bool) (string, error) {
	svcUseRequest := &ServiceUseRequest{ServiceID: serviceID, ImageID: imageID, ReplaceImg: replaceImg, Registry: registry, NoOp: noOp}
	result := ""
