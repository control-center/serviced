...
func initElasticSearch() {
	...
	elasticsearch_serviced.Command = func() string {
		...
		cmd := fmt.Sprintf(`export ES_JAVA_HOME=/opt/elasticsearch-serviced/jdk; su elastic -c 'exec /opt/elasticsearch-serviced/bin/elasticsearch -Ecluster.initial_master_nodes="%s" -Enode.name="%s" %s'`,
