...
func (s *CliAPITestSuite) TestEnvironConfigReader_StringMap_Empty(c *C) {
	listValue := []string{""}
...
func (s *CliAPITestSuite) TestEnvironConfigReader_StringMap_Simple(c *C) {
...
func (s *CliAPITestSuite) TestEnvironConfigReader_StringMap_Multiple(c *C) {
...
func (s *CliAPITestSuite) TestEnvironConfigReader_StringMap_EmptyPair(c *C) {
...
func (s *CliAPITestSuite) TestEnvironConfigReader_StringMap_InvalidPair(c *C) {
