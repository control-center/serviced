...
func New(driver api.API, config utils.ConfigReader, logControl logging.LogControl) *ServicedCli {
	...
	c.app.Flags = []cli.Flag{
		...
		cli.StringFlag{"isvcs-opentsdb-username", defaultOps.IsvcsOpenTsdbUsername, "isvcs opentsdb username"},
		cli.StringFlag{"isvcs-opentsdb-passwd", defaultOps.IsvcsOpenTsdbPasswd, "isvcs opentsdb password"},
		cli.StringFlag{"zk-acl-user", defaultOps.ZkAclUser, "zookeeper acl user"},
		cli.StringFlag{"zk-acl-passwd", defaultOps.ZkAclPasswd, "zookeeper acl password"},
...
func getRuntimeOptions(cfg utils.ConfigReader, ctx *cli.Context) config.Options {
	options := config.Options{
		...
		IsvcsOpenTsdbUsername:      ctx.GlobalString("isvcs-opentsdb-username"),
		IsvcsOpenTsdbPasswd:        ctx.GlobalString("isvcs-opentsdb-passwd"),
		ZkAclUser:                  ctx.GlobalString("zk-acl-user"),
		ZkAclPasswd:                ctx.GlobalString("zk-acl-passwd"),
