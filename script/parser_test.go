...
func (vs *ScriptSuite) Test_parseFile(t *C) {
	...
	ctx.line = "SVC_USE  zenoss/resmgr_5.0:5.0.1 replace_me service path_to_service"
	ctx.lineNum = 14
	use5, _ := nodeFactories[USE](ctx, USE, []string{"zenoss/resmgr_5.0:5.0.1", "replace_me", "service", "path_to_service"})

	ctx.line = "SVC_USE  zenoss/multi_replace:6.7 replace_me org/replace_me_too service path_to_service"
	ctx.lineNum = 15
	use6, _ := nodeFactories[USE](ctx, USE, []string{"zenoss/multi_replace:6.7", "replace_me", "org/replace_me_too", "service", "path_to_service"})
	...
	expected := []node{
		...
		node{lineNum: 18, cmd: SVC_STOP, line: "SVC_STOP Zenoss.core/mariadb", args: []string{"Zenoss.core/mariadb"}},
		node{lineNum: 19, cmd: SVC_WAIT, line: "SVC_WAIT Zenoss.core/mariadb stopped 0", args: []string{"Zenoss.core/mariadb", "stopped", "0"}},
		node{lineNum: 20, cmd: SVC_START, line: "SVC_START Zenoss.core/mariadb", args: []string{"Zenoss.core/mariadb"}},
		node{lineNum: 21, cmd: SVC_WAIT, line: "SVC_WAIT Zenoss.core/mariadb started 30", args: []string{"Zenoss.core/mariadb", "started", "30"}},
		node{lineNum: 22, cmd: SVC_RESTART, line: "SVC_RESTART Zenoss.core/mariadb", args: []string{"Zenoss.core/mariadb"}},
		node{lineNum: 23, cmd: SVC_WAIT, line: "SVC_WAIT Zenoss.core/mariadb started 30", args: []string{"Zenoss.core/mariadb", "started", "30"}},
		node{lineNum: 24, cmd: SVC_RUN, line: "SVC_RUN  Zenoss.core/Zope upgrade", args: []string{"Zenoss.core/Zope", "upgrade"}},
		node{lineNum: 25, cmd: SVC_RUN, line: "SVC_RUN  Zenoss.core/HBase/RegionServer upgrade arg1 arg2", args: []string{"Zenoss.core/HBase/RegionServer", "upgrade", "arg1", "arg2"}},
		node{lineNum: 26, cmd: SVC_EXEC, line: "SVC_EXEC COMMIT Zenoss.core/Zope command1", args: []string{"COMMIT", "Zenoss.core/Zope", "command1"}},
		node{lineNum: 27, cmd: SVC_EXEC, line: "SVC_EXEC NO_COMMIT Zenoss.core/zenhub command2 with args", args: []string{"NO_COMMIT", "Zenoss.core/zenhub", "command2", "with", "args"}},
		node{lineNum: 28, cmd: SVC_START, line: "SVC_START Zenoss.core", args: []string{"Zenoss.core"}},
		node{lineNum: 29, cmd: SVC_WAIT, line: "SVC_WAIT Zenoss.core started recursive", args: []string{"Zenoss.core", "started", "recursive"}},
	}
