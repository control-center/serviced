...
func (vs *ScriptSuite) Test_parseFile(t *C) {
	...
	expected := []node{
		...
		use2,
		use3,
		node{lineNum: 13, cmd: SVC_START, line: "SVC_START Zenoss.core/mariadb", args: []string{"Zenoss.core/mariadb"}},
		node{lineNum: 14, cmd: SVC_WAIT, line: "SVC_WAIT Zenoss.core/mariadb started 30", args: []string{"Zenoss.core/mariadb", "started", "30"}},
		node{lineNum: 15, cmd: SVC_STOP, line: "SVC_STOP Zenoss.core/mariadb", args: []string{"Zenoss.core/mariadb"}},
		node{lineNum: 16, cmd: SVC_WAIT, line: "SVC_WAIT Zenoss.core/mariadb stopped 0", args: []string{"Zenoss.core/mariadb", "stopped", "0"}},
		node{lineNum: 17, cmd: SVC_START, line: "SVC_START Zenoss.core/mariadb", args: []string{"Zenoss.core/mariadb"}},
		node{lineNum: 18, cmd: SVC_WAIT, line: "SVC_WAIT Zenoss.core/mariadb started 30", args: []string{"Zenoss.core/mariadb", "started", "30"}},
		node{lineNum: 19, cmd: SVC_RESTART, line: "SVC_RESTART Zenoss.core/mariadb", args: []string{"Zenoss.core/mariadb"}},
		node{lineNum: 20, cmd: SVC_WAIT, line: "SVC_WAIT Zenoss.core/mariadb started 30", args: []string{"Zenoss.core/mariadb", "started", "30"}},
		node{lineNum: 21, cmd: SVC_RUN, line: "SVC_RUN  Zenoss.core/Zope upgrade", args: []string{"Zenoss.core/Zope", "upgrade"}},
		node{lineNum: 22, cmd: SVC_RUN, line: "SVC_RUN  Zenoss.core/HBase/RegionServer upgrade arg1 arg2", args: []string{"Zenoss.core/HBase/RegionServer", "upgrade", "arg1", "arg2"}},
		node{lineNum: 23, cmd: SVC_EXEC, line: "SVC_EXEC COMMIT Zenoss.core/Zope command1", args: []string{"COMMIT", "Zenoss.core/Zope", "command1"}},
		node{lineNum: 24, cmd: SVC_EXEC, line: "SVC_EXEC NO_COMMIT Zenoss.core/zenhub command2 with args", args: []string{"NO_COMMIT", "Zenoss.core/zenhub", "command2", "with", "args"}},
	}
