...
func (s *ControlClient) DeployTemplate(request dao.ServiceTemplateDeploymentRequest, rootServiceId *string) error {
	return s.rpcClient.Call("ControlPlane.DeployTemplate", request, rootServiceId)
}
