...
func (_m *API) AddHost(ctx datastore.Context, entity *host.Host) ([]byte, error) {
...
func (_m *API) AddHostPrivate(ctx datastore.Context, entity *host.Host) ([]byte, error) {
	ret := _m.Called(ctx, entity)
...
func (_m *API) AddPublicEndpointPort(ctx datastore.Context, serviceid string, endpointName string, portAddr string, usetls bool, protocol string, isEnabled bool, restart bool) (*servicedefinition.Port, error) {
...
func (_m *API) AddPublicEndpointVHost(ctx datastore.Context, serviceid string, endpointName string, vhost string, isEnabled bool, restart bool) (*servicedefinition.VHost, error) {
...
func (_m *API) AddResourcePool(ctx datastore.Context, entity *pool.ResourcePool) error {
	ret := _m.Called(ctx, entity)
...
func (_m *API) AddService(ctx datastore.Context, svc service.Service) error {
...
func (_m *API) AddServiceConfig(ctx datastore.Context, serviceID string, conf servicedefinition.ConfigFile) error {
...
func (_m *API) AddServiceTemplate(ctx datastore.Context, serviceTemplate servicetemplate.ServiceTemplate, reloadLogstashConfig bool) (string, error) {
...
func (_m *API) AddUser(ctx datastore.Context, newUser user.User) error {
...
func (_m *API) AssignIPs(ctx datastore.Context, assignmentRequest addressassignment.AssignmentRequest) error {
...
func (_m *API) RemoveIPs(ctx datastore.Context, args []string) error {
...
func (_m *API) SetIPs(ctx datastore.Context, assignmentRequest addressassignment.AssignmentRequest) error {
	ret := _m.Called(ctx, assignmentRequest)
...
func (_m *API) ClearEmergencyStopFlag(ctx datastore.Context, serviceID string) (int, error) {
...
func (_m *API) CountDescendantStates(ctx datastore.Context, serviceID string) (map[string]map[string]int, error) {
	ret := _m.Called(ctx, serviceID)
...
func (_m *API) DeleteServiceConfig(ctx datastore.Context, fileID string) error {
...
func (_m *API) DeployTemplate(ctx datastore.Context, poolID string, templateID string, deploymentID string) ([]string, error) {
...
func (_m *API) DeployTemplateActive() ([]map[string]string, error) {
	ret := _m.Called()
...
func (_m *API) DeployTemplateStatus(deploymentID string, lastStatus string, timeout time.Duration) (string, error) {
...
func (_m *API) EmergencyStopService(ctx datastore.Context, request dao.ScheduleServiceRequest) (int, error) {
...
func (_m *API) EnablePublicEndpointPort(ctx datastore.Context, serviceid string, endpointName string, portAddr string, isEnabled bool) error {
...
func (_m *API) EnablePublicEndpointVHost(ctx datastore.Context, serviceid string, endpointName string, vhost string, isEnabled bool) error {
...
func (_m *API) FindHostsInPool(ctx datastore.Context, poolID string) ([]host.Host, error) {
...
func (_m *API) FindReadHostsInPool(ctx datastore.Context, poolID string) ([]host.ReadHost, error) {
	ret := _m.Called(ctx, poolID)
...
func (_m *API) GetActiveHostIDs(ctx datastore.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
func (_m *API) GetAggregateServices(ctx datastore.Context, since time.Time, serviceids []string) ([]service.AggregateService, error) {
...
func (_m *API) GetAllPublicEndpoints(ctx datastore.Context) ([]service.PublicEndpoint, error) {
	ret := _m.Called(ctx)
...
func (_m *API) GetEvaluatedService(ctx datastore.Context, servicedID string, instanceID int) (*service.Service, error) {
...
func (_m *API) GetHealthChecksForService(ctx datastore.Context, id string) (map[string]health.HealthCheck, error) {
...
func (_m *API) GetHost(ctx datastore.Context, hostID string) (*host.Host, error) {
...
func (_m *API) GetHostInstances(ctx datastore.Context, since time.Time, hostid string) ([]service.Instance, error) {
...
func (_m *API) GetHostKey(ctx datastore.Context, hostID string) ([]byte, error) {
	ret := _m.Called(ctx, hostID)
...
func (_m *API) GetHostStatuses(ctx datastore.Context, hostIDs []string, since time.Time) ([]host.HostStatus, error) {
...
func (_m *API) GetHosts(ctx datastore.Context) ([]host.Host, error) {
	ret := _m.Called(ctx)
...
func (_m *API) GetPoolIPs(ctx datastore.Context, poolID string) (*pool.PoolIPs, error) {
	ret := _m.Called(ctx, poolID)
...
func (_m *API) GetReadHosts(ctx datastore.Context) ([]host.ReadHost, error) {
	ret := _m.Called(ctx)
...
func (_m *API) GetReadPools(ctx datastore.Context) ([]pool.ReadPool, error) {
	ret := _m.Called(ctx)
...
func (_m *API) GetResourcePool(ctx datastore.Context, poolID string) (*pool.ResourcePool, error) {
	ret := _m.Called(ctx, poolID)
...
func (_m *API) GetResourcePools(ctx datastore.Context) ([]pool.ResourcePool, error) {
	ret := _m.Called(ctx)
...
func (_m *API) GetService(ctx datastore.Context, id string) (*service.Service, error) {
	ret := _m.Called(ctx, id)
...
func (_m *API) GetServiceAddressAssignmentDetails(ctx datastore.Context, serviceID string, children bool) ([]service.IPAssignment, error) {
...
func (_m *API) GetServiceConfig(ctx datastore.Context, fileID string) (*servicedefinition.ConfigFile, error) {
	ret := _m.Called(ctx, fileID)
...
func (_m *API) GetServiceConfigs(ctx datastore.Context, serviceID string) ([]service.Config, error) {
	ret := _m.Called(ctx, serviceID)
...
func (_m *API) GetServiceDetails(ctx datastore.Context, serviceID string) (*service.ServiceDetails, error) {
	ret := _m.Called(ctx, serviceID)
...
func (_m *API) GetServiceDetailsAncestry(ctx datastore.Context, serviceID string) (*service.ServiceDetails, error) {
	ret := _m.Called(ctx, serviceID)
...
func (_m *API) GetServiceDetailsByParentID(ctx datastore.Context, serviceID string, since time.Duration) ([]service.ServiceDetails, error) {
...
func (_m *API) GetServiceDetailsByTenantID(ctx datastore.Context, tenantID string) ([]service.ServiceDetails, error) {
...
func (_m *API) GetServiceExportedEndpoints(ctx datastore.Context, serviceID string, children bool) ([]service.ExportedEndpoint, error) {
	ret := _m.Called(ctx, serviceID, children)
...
func (_m *API) GetServiceInstances(ctx datastore.Context, since time.Time, serviceid string) ([]service.Instance, error) {
...
func (_m *API) GetServiceMonitoringProfile(ctx datastore.Context, serviceID string) (*domain.MonitorProfile, error) {
	ret := _m.Called(ctx, serviceID)
...
func (_m *API) GetServicePublicEndpoints(ctx datastore.Context, serviceID string, children bool) ([]service.PublicEndpoint, error) {
	ret := _m.Called(ctx, serviceID, children)
...
func (_m *API) GetServiceTemplates(ctx datastore.Context) (map[string]servicetemplate.ServiceTemplate, error) {
	ret := _m.Called(ctx)
...
func (_m *API) GetServices(ctx datastore.Context, request dao.EntityRequest) ([]service.Service, error) {
	ret := _m.Called(ctx, request)
...
func (_m *API) GetServicesHealth(ctx datastore.Context) (map[string]map[int]map[string]health.HealthStatus, error) {
	ret := _m.Called(ctx)
...
func (_m *API) GetSystemUser(ctx datastore.Context) (user.User, error) {
	ret := _m.Called(ctx)
...
func (_m *API) GetTaggedServices(ctx datastore.Context, request dao.EntityRequest) ([]service.Service, error) {
	ret := _m.Called(ctx, request)
...
func (_m *API) GetTenantID(ctx datastore.Context, serviceID string) (string, error) {
	ret := _m.Called(ctx, serviceID)
...
func (_m *API) GetUser(ctx datastore.Context, userName string) (user.User, error) {
...
func (_m *API) HasIP(ctx datastore.Context, poolID string, ipAddr string) (bool, error) {
...
func (_m *API) HostIsAuthenticated(ctx datastore.Context, hostid string) (bool, error) {
	ret := _m.Called(ctx, hostid)
...
func (_m *API) ListTenants(_a0 datastore.Context) ([]string, error) {
	ret := _m.Called(_a0)
...
func (_m *API) MigrateServices(ctx datastore.Context, request dao.ServiceMigrationRequest) error {
	ret := _m.Called(ctx, request)
...
func (_m *API) PredictStorageAvailability(ctx datastore.Context, lookahead time.Duration) (map[string]float64, error) {
...
func (_m *API) RegisterHostKeys(ctx datastore.Context, entity *host.Host, nat utils.URL, keys []byte, prompt bool) error {
...
func (_m *API) ReloadLogstashConfig(ctx datastore.Context) error {
	ret := _m.Called(ctx)
...
func (_m *API) RemoveHost(ctx datastore.Context, hostID string) error {
	ret := _m.Called(ctx, hostID)
...
func (_m *API) RemoveHostExpiration(ctx datastore.Context, hostID string) {
...
func (_m *API) RemovePublicEndpointPort(ctx datastore.Context, serviceid string, endpointName string, portAddr string) error {
...
func (_m *API) RemovePublicEndpointVHost(ctx datastore.Context, serviceid string, endpointName string, vhost string) error {
...
func (_m *API) RemoveResourcePool(ctx datastore.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *API) RemoveService(ctx datastore.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *API) RemoveServiceTemplate(ctx datastore.Context, templateID string) error {
...
func (_m *API) RemoveUser(ctx datastore.Context, userName string) error {
	ret := _m.Called(ctx, userName)
...
func (_m *API) ReportHealthStatus(key health.HealthStatusKey, value health.HealthStatus, expires time.Duration) {
	_m.Called(key, value, expires)
}

// ReportInstanceDead provides a mock function with given fields: serviceID, instanceID
func (_m *API) ReportInstanceDead(serviceID string, instanceID int) {
	_m.Called(serviceID, instanceID)
}

// ResetHostKey provides a mock function with given fields: ctx, hostID
func (_m *API) ResetHostKey(ctx datastore.Context, hostID string) ([]byte, error) {
	ret := _m.Called(ctx, hostID)
...
func (_m *API) ScheduleServices(ctx datastore.Context, serviceIDs []string, autoLaunch bool, synchronous bool, desiredState service.DesiredState, emergency bool) (int, error) {
...
func (_m *API) SetHostExpiration(ctx datastore.Context, hostID string, expiration int64) {
	_m.Called(ctx, hostID, expiration)
}

//StartService provides a mock function with given fields: ctx, ScheduleServiceRequest
func (_m *API) StartService(ctx datastore.Context, request dao.ScheduleServiceRequest) (int, error) {
...
func (_m *API) StopService(ctx datastore.Context, request dao.ScheduleServiceRequest) (int, error) {
...
func (_m *API) PauseService(ctx datastore.Context, request dao.ScheduleServiceRequest) (int, error) {
...
func (_m *API) RestartService(ctx datastore.Context, request dao.ScheduleServiceRequest) (int, error) {
...
func (_m *API) SyncServiceRegistry(ctx datastore.Context, svc *service.Service) error {
	ret := _m.Called(ctx, svc)
...
func (_m *API) UpdateHost(ctx datastore.Context, entity *host.Host) error {
	ret := _m.Called(ctx, entity)
...
func (_m *API) UpdateResourcePool(ctx datastore.Context, entity *pool.ResourcePool) error {
	ret := _m.Called(ctx, entity)
...
func (_m *API) UpdateService(ctx datastore.Context, svc service.Service) error {
	ret := _m.Called(ctx, svc)
...
func (_m *API) UpdateServiceCache(ctx datastore.Context) error {
	ret := _m.Called(ctx)
...
func (_m *API) UpdateServiceConfig(ctx datastore.Context, fileID string, conf servicedefinition.ConfigFile) error {
...
func (_m *API) UpdateServiceTemplate(ctx datastore.Context, template servicetemplate.ServiceTemplate, reloadLogstashConfig bool) error {
...
func (_m *API) UpdateUser(ctx datastore.Context, u user.User) error {
	ret := _m.Called(ctx, u)
...
func (_m *API) ValidateCredentials(ctx datastore.Context, u user.User) (bool, error) {
	ret := _m.Called(ctx, u)
...
func (_m *API) WaitService(ctx datastore.Context, dstate service.DesiredState, timeout time.Duration, recursive bool, serviceIDs ...string) error {
...
func (_m *API) QueryServiceDetails(ctx datastore.Context, query service.Query) ([]service.ServiceDetails, error) {
...
func (_m *API) GetServiceNamePath(ctx datastore.Context, serviceID string) (string, string, error) {
	ret := _m.Called(ctx, serviceID)
