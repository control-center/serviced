...
func (m *FacadeInterface) AddPublicEndpointVHost(ctx datastore.Context, serviceid, endpointName, portAddr string, isEnabled, restart bool) (*servicedefinition.VHost, error) {
	ret := m.Called(ctx, serviceid, endpointName, portAddr, isEnabled, restart)
