...
func (_m *ZZK) WaitInstance(ctx datastore.Context, svc *service.Service, instanceID int, state service.DesiredState, cancel <-chan interface{}) error {
	ret := _m.Called(ctx, svc, instanceID, state, cancel)

	var r0 error
	if rf, ok := ret.Get(0).(func(datastore.Context, *service.Service, int, service.DesiredState, <-chan interface{}) error); ok {
