...
type FacadeInterface interface {
	AddService(ctx datastore.Context, svc service.Service, isRemote, assignIP bool) error
	...
	UpdateService(ctx datastore.Context, svc service.Service, isRemote bool) error
